...
| File | Job |
|---|---|
| [[dev-root-README|dev-root README]] | Covers [[docmap|Docmap]] and [[project-inventory|Project Inventory]]. Verified/corrected and current — not pending rewrite. |
| [[docs-manager-README|Docs Manager README]] | Short-form guide to Docs Manager |
| `mb-align-docs-README.md` | This file |
| [[docmap|Docmap]] | Map of the `C:\dev\` folder structure — Docs Manager's territory |
| [[project-inventory|Project Inventory]] | List of active projects under `C:\dev\` — Docs Manager's territory |
