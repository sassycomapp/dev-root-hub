Task: Front-matter retrofit — mb5pdlf-project-library.
Scope is strictly limited to: C:\dev\dev-mb5pdlf\mb5pdlf-project-library\
...
(C:\projects-reference\custom-skills-store\mb-align-docs\front-matter-schema.md):
  ...
  - doc-id: assigned sequentially as "mb5pdlf-0001", "mb5pdlf-0002", etc.,
...
In scope: all .md documents inside mb5pdlf-project-library's content
...
Confirm the mb5pdlf-project-library git working tree is clean before
proceeding. If dirty, stop and report — do not proceed.

Step 2 — Backup.
Take a full backup of mb5pdlf-project-library before any write. Save the
