Task: Front-matter retrofit — mb4ecom-project-library.
Scope is strictly limited to: C:\dev\dev-mb4ecom\mb4ecom-project-library\
...
— this prompt already builds in the corrected timestamp method from the
start, so no separate correction pass should be needed afterward.
...
(C:\projects-reference\custom-skills-store\mb-align-docs\front-matter-schema.md):
  ...
  - doc-id: assigned sequentially as "mb4ecom-0001", "mb4ecom-0002", etc.,
...
In scope: all .md documents inside mb4ecom-project-library's content
...
Confirm the mb4ecom-project-library git working tree is clean before
proceeding. If dirty, stop and report — do not proceed.

Step 2 — Backup.
Take a full backup of mb4ecom-project-library before any write. Save the
